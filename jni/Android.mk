...
ZKSW_PREBUILT_ROOT_PATH := $(MY_ZKSW_PREBUILT_PATH)
ZKSW_PREBUILT_LIB_PATH := $(ZKSW_PREBUILT_ROOT_PATH)/lib/
ZKSW_PREBUILT_INCLUDE_PATH := $(ZKSW_PREBUILT_ROOT_PATH)/include/
